...
export const aboutGallery: AboutGalleryEntry[] = [
  {
    ...
    title: "Una pequeña colección de encuadernaciones",
    caption: "Papeles chiyogami verdes y calipso encontrados en Reako, Osaka, junto a un papel de arroz rojo con detalles dorados.",
  ...
  },
  {
    ...
    alt: "Cuaderno de papel de arroz rojo con detalles dorados y costura copta visible sobre una base de corte azul",
    title: "Coptic binding",
    caption: "Una encuadernación copta revestida con papel de arroz rojo y detalles dorados, pensada para contenidos más estáticos. La costura expuesta une los cuadernillos y permite que el libro se abra con comodidad.",
    category: "bookbinding",
    date: "Diciembre 2025",
    orientation: "landscape",
  },
