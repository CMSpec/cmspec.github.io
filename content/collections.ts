...
export const collections: EditorialCollection[] = [
  {
    ...
    deck: "Ideas matemáticas que aparecen en mapas, juegos y otros objetos cotidianos, desarrolladas con tiempo y curiosidad.",
    colophon: "Estas notas conectan una pregunta cercana con la estructura matemática que permite mirarla de otra manera.",
    tone: "blue",
    entries: [
      {
        number: "01",
        title: "Por qué ningún mapa conserva todas las distancias",
        subtitle: "Curvatura, transformaciones conformes y decisiones cartográficas",
        ...
        introduction: "Un mapa parece una versión reducida del territorio, pero para dibujar la Tierra sobre una superficie plana hay que deformarla. La pregunta interesante no es cómo evitar toda distorsión, sino qué propiedad decidimos conservar y por qué.",
        sections: [],
      },
      {
        number: "02",
        ...
        href: "/investigacion/dobble-y-geometria-proyectiva",
        visual: "p ∈ ℓ",
        eyebrow: "02 / COMBINATORIA & GEOMETRÍA FINITA",
        introduction: "Dobble propone una tarea muy concreta: dadas dos cartas, encontrar el único símbolo que comparten. Que esa coincidencia exista siempre no es casualidad; puede construirse a partir de una geometría con un número finito de puntos y rectas.",
        sections: [],
      },
    ],
  },
