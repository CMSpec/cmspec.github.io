...
% Marca conceptos que deben aparecer en el índice lateral de CMSpec.
% Ejemplo: \cmspecindice{Matriz}
\newcommand{\cmspecindice}[1]{}
% Posiciona una animación o visualización de CMSpec dentro del apunte web.
% Ejemplo: \cmspecvisual{traza}
