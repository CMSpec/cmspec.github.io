...
\begin{ejer}Encuentra una solución explícita de la siguiente ecuación diferencial de orden 1
\end{ejer}
...
\begin{sol}Es una ecuación de Bernoullí, usamos el cambio de variable $z=y^{1-3}=y^{-2}$, luego $z'=-2y^{-3}y'$ o bien $y'= -y^3/2 z'$, reemplazando obtenemos
\end{sol}
...
\begin{ejer}Resuelva la siguiente ecuación diferencial \\
\end{ejer}
...
\begin{sol}Tenemos $M= 5x+4$ y  $N= 4x-8y^3$, luego
\end{sol}
...
\begin{ejer}Resuelva el siguiente PVI usando coeficientes indeterminados
\end{ejer}
...
\begin{sol}Primero resolvemos la homogenea usando $y=e^{mx}$, obtenemos el polinomio asociado
\end{sol}
...
\begin{ejer}Resuelva el siguiente PVI usando variación de parámetros
\end{ejer}
...
De donde se deduce que $m_1=3i$ y $m_2=-3i$, $y_1=\cos(3x)$ e $y_2=\sin(3x)$ de esta forma la solución de la homogenea es
...
\begin{align*}
    C_1(x) &= -\frac{1}{3}\int \sin(3x)\sin(3x) dx\\
    &= -\frac{1}{3}\int \sin^2(3x) dx\\
\end{align*}
...
\begin{align*}
    C_1(x) &= -\frac{1}{3}\int \sin(3x)\sin(3x) dx\\
    &= -\frac{1}{9}\int \sin^2(u) du\\
    &= -\frac{1}{9}\left( \frac{u}{2}-\frac{\sin(2u)}{4} \right) \\
    &= -\frac{1}{9}\left( \frac{3x}{2}-\frac{\sin(6x)}{4} \right) \\
\end{align*}

Por otra parte

\begin{align*}
    C_2(x) &= \frac{1}{3}\int \cos(3x)\sin(3x) dx\\
\end{align*}

haciendo $u=\cos(3x)$, se tiene $du=3\sin(3x)dx$, luego
...
\begin{align*}
    y &=   c_1\cos(3x)+c_2\sin(3x)+ \left( -\frac{1}{9}\left( \frac{3x}{2}-\frac{\sin(6x)}{4} \right) \right)\cos(3x)+ \left( -\frac{1}{18}\cos^2(3x) \right)\sin(3x) \\
    &=   c_1\cos(3x)+c_2\sin(3x)-\frac{1}{6}x\cos(3x)+\frac{1}{36}\sin(6x)\cos(3x)-\frac{1}{18}\cos^2(3x)\sin(3x) \\
    &=   c_1\cos(3x)+c_2\sin(3x)-\frac{1}{6}x\cos(3x)+\frac{1}{36}2\sin(3x)\cos(3x)\cos(3x)-\frac{1}{18}\cos^2(3x)\sin(3x) \\
     &=   c_1\cos(3x)+c_2\sin(3x)-\frac{1}{6}x\cos(3x)+\frac{1}{18}2\sin(3x)\cos^2(3x)-\frac{1}{18}\cos^2(3x)\sin(3x) \\
