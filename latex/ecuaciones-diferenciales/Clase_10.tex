...
\begin{thm}[Segundo teorema de traslación]Sea $f: [0,+\infty) \to \mathbb{R}$ continua por trozos y de orden exponencial. Si $a \in \mathbb{R}^+$, entonces
\end{thm}
...
\begin{thm}[Versión transformada inversa]Sea $f: [0,+\infty) \to \mathbb{R}$ continua por trozos y de orden exponencial. Si $a \in \mathbb{R}^+$, entonces
\end{thm}
...
\begin{sol}Aplicamos transformada de Laplace, tenemos que
\end{sol}
...
\begin{prop}Sea $f$ una función de orden exponencial y $n \in \mathbb{N}$, entonces
\end{prop}
...
\begin{ejem}Calculemos la transformada de Laplace de $f(t) =t\sin(at) $, sabemos que
\end{ejem}
...
\begin{ejem}Calculemos la transformada de Laplace de $f(t) =\displaystyle \frac{\sin(at)}{t}$ con $a>0$, sabemos que
\end{ejem}
