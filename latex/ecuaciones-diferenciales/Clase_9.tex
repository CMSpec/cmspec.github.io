...
\begin{ejem}Resolver $y'+2y=4t$ con la condición inicial $y(0)=3$, usando transformadas de Laplace.  \\
\end{ejem}

\begin{sol}Primero aplicamos la transformada de Laplace  a ambos lados
\end{sol}
...
\begin{ejem}Resolver $y''+3y=0$  con las condiciones iniciales $y(0)=1$ y $y'(0)=2$, usando transformadas de Laplace.  \\
\end{ejem}
...
\begin{center}
$\displaystyle y = \cos(\sqrt{3} t) +  \frac{2}{\sqrt{3}}\sin(\sqrt{3}t)$
\end{center}
...
\begin{thm}[Primer teorema de traslación]Sea $f: [0,\infty) \to \mathbb{R}$ continua por tramos y de orden exponencial. Si $a\in \mathbb{R}$, entonces
\end{thm}
...
\begin{thm}[Versión transformada inversa]Sea $f: [0,\infty) \to \mathbb{R}$ continua por tramos y de orden exponencial. Si $a\in \mathbb{R}$, entonces
\end{thm}
...
\begin{center}
$\displaystyle \mathcal{L}^{-1} \left[ \frac{1}{s^2+4} \right](t) = \frac{1}{2} \mathcal{L}^{-1} \left[ \frac{2}{s^2+4} \right](t) = \frac{\sin(2t)}{2}$
\end{center}

Por lo tanto

\begin{center}
$\displaystyle \mathcal{L}^{-1} \left[ \frac{1}{(s-3)^2+4} \right](t) = \frac{1}{2} e^{3t}\sin(2t)$
\end{center}
...
\begin{defin}La función de Heaviside $u_{t_0}(t) = u(t-t_0)$ se define como
\end{defin}
...
\begin{ejem}Caclular la transformada de laplace de la siguiente función
\end{ejem}
...
\begin{sol}El valor $-1$ se deja aparte, el segundo valor será $4-(-1)=5$ y el tercer valor será $7-4=3$. En cuanto a los valores de los intervalos, estos son los mismos que los de $f$, es decir $5$ y $12$, luego
\end{sol}
