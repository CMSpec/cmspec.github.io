...
\textbf{Definición:} Dada una función vectorial $r: \mathbb{R} \to \mathbb{R}^3$ dada por $r(t) = (r_1(t),r_2(t),r_3(t))$, podemos definir la \textbf{derivada $r'$}, como
...
\textbf{Definición:} Dada una función vectorial $r(t)$ se define el vector tangente unitario a la curva en  $t$ como
...
\textbf{Ejemplo 1: } Sea la curva dada por $r(t) = (t, \sen(t), t^2)$, tenemos que
...
\textbf{Definición: } Dada una función vectorial $r(t)$ se define el \textbf{vector normal}  unitario a la curva en  $t$ como
...
\textbf{Definici\'on: }Sea $P =(x_0,y_0,z_0)\in \mathbb{R}^3$ un punto de la curva $r(t)$, con $r(t_0) = (x_0,y_0,z_0)$, el \textbf{plano osculador de $r$ en el punto $P$}, es el plano que pasa por el punto $(x_0,y_0,z_0)$ y que tiene por vector normal $B(t_0)$, su ecuaci\'on viene dada por

\begin{align*}
    B(t_0) \cdot ((x,y,z)- (x_0,y_0,z_0)) = 0
\end{align*}

\textbf{Definici\'on: }Sea $P =(x_0,y_0,z_0)\in \mathbb{R}^3$ un punto de la curva $r(t)$, con $r(t_0) = (x_0,y_0,z_0)$, el \textbf{plano normal de $r$ en el punto $P$}, es el plano que pasa por el punto $(x_0,y_0,z_0)$ y que tiene por vector normal $T(t_0)$, su ecuaci\'on viene dada por
...
\textbf{Definici\'on: }Sea $P =(x_0,y_0,z_0)\in \mathbb{R}^3$ un punto de la curva $r(t)$, con $r(t_0) = (x_0,y_0,z_0)$, el \textbf{plano rectificante de $r$ en el punto $P$}, es el plano que pasa por el punto $(x_0,y_0,z_0)$ y que tiene por vector normal $N(t_0)$, su ecuaci\'on viene dada por
...
\textbf{Ejercicio:} Sea $r(t) = (\cos(t),\sin(t),t)$, determine el vector tangente, el vector normal y el vector binormal, adem\'as determine las ecuaciones del plano osculador, el plano normal y el plano rectificante en $t=0$. \\

\textbf{Respuesta: } Calculamos la derivada de la curva
...
\textit{Nota:} Esta demostraci\'on no es del todo rigurosa porque la forma en la que hemos llegado a la integral es un poco ambigua, en el sentido de que no deber\'ia conicidir exactamente con la integral de Riemann cl\'asica, sin embargo una demostraci\'on m\'as rigurosa tomar\'ia demasiado tiempo. \\
...
\textbf{Ejemplo: } Calcular la longitud de la curva parametrizada por
\[
\vec{r}(t) = \langle \cos(t), \sin(t), t \rangle, \quad \text{para } t \in [0, 2\pi].
\]

\textbf{Respuesta:} Primero derivamos 
\[
r'(t) = ( -\sin(t), \cos(t), 1 )
\]
...
\textbf{Ejercicio para los alumnos: } Determinar la longitud de la curva $r(t) = (1,t,t^2)$, entre los puntos $(1,0,0)$ y $(1,1,1)$ \\
...
\textbf{Definición:} Sea $r: \mathbb{R} \to \mathbb{R}^3$ función vecotrial, la curvatura de $r$ en el punto $t$ se define por
...
\textbf{Ejercicio:} Calcular la curvatura de la curva
