...
Para funciones $f: \mathbb{R}^2 \to \mathbb{R}$ se puede hacer uso de cambio a coordenadas polares $x = \rho \cos(\theta)$ y $y = \rho \sin(\theta)$ y entonces si el limite existe



\begin{align*}
\displaystyle \lim_{(x,y) \to (0,0)}   f(x,y)   &=  \lim_{\rho \to 0} f(\rho \cos(\theta), \rho \sin(\theta))
\end{align*}
...
\begin{align*}
\displaystyle \lim_{(x,y) \to (0,0)}   \frac{x^2\sin(x^2+y^2)}{\sqrt{x^2+y^2}}  &=  \lim_{\rho \to 0}  \frac{\rho^2 \cos^2(\theta)\sin(\rho^2)}{\rho} \\
&=  \lim_{\rho \to 0}  \rho \cos^2(\theta)\sin(\rho^2) \\
\end{align*}

Ahora bien indpendiente del angulo $\theta$ el limite siempre es cero porque las funcions $\sin$ y $\cos$ estan acotadas, luego
...
\begin{align*}
f(x,y) = \left\{ \begin{array}{lcc} \frac{x^2\sin^2(y)}{x^2+y^2} & si & (x,y) \neq (0,0) \\ \\ 0 & si & (x,y) =(0,0) \end{array} \right.
\end{align*}
...
\begin{align*}
\lim_{(x,y) \to (0,0)} f(x,y) &= \lim_{(x,y) \to (0,0)} \frac{x^2\sin^2(y)}{x^2+y^2} \\
\end{align*}
...
\begin{align*}
\lim_{(x,y) \to (0,0)} f(x,y) &= \lim_{(x,y) \to (0,0)} \frac{x^2\sin^2(y)}{x^2+y^2} \\
&= \lim_{\rho \to 0} \frac{\rho^2 \cos^2(\theta)\sin^2(\rho \sin(\theta))}{\rho^2} \\
&= \lim_{\rho \to 0} \cos^2(\theta)\sin^2(\rho \sin(\theta)) \\
&=0
\end{align*}
...
\begin{align*}
   \frac{\partial h}{\partial x} = ze^{xz}-\sin(x+y)
\end{align*}

\textbf{Actividad: } Calcular las tres derivadas parciales de las siguientes funciones\\
