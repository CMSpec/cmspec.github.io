...
export function ComplexDiagrams({ variant }: { variant: "complex-plane" | "complex-geometry" | "complex-roots" }) {
  ...
  return <div className="intro-complex-grid">
    ...
    <figure className="intro-complex-figure"><Plane title="Los cuatro puntos del ejemplo de clase" points={[[-2,3,"z₁"],[4,4,"z₂"],[2,-1,"z₃"],[2,1,"conjugado z₃"]]} guides/><figcaption>z₁ = −2+3i; z₂ = 4+4i; z₃ = 2−i; conjugado de z₃ = 2+i.</figcaption></figure>
  </div>;
}
